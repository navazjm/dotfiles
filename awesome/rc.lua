...
-- Destroy all notifications
    ...
    -- X screen locker
    awful.key({ modkey, "Control" }, "x", function() os.execute(scrlocker) end,
    ...
    awful.key({ modkey }, "a", function() awful.spawn(audio) end,
        { description = "run pavucontrol", group = "launcher" }),
    awful.key({ modkey }, "o", function() awful.spawn(obs) end,
        { description = "run obs", group = "launcher" }),
    awful.key({ modkey }, "f", function() awful.spawn.with_shell(fileExp) end,
